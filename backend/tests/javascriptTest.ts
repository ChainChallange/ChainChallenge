...
const jsCode = `export function sum (a, b) {
  return a + b
}
...
const application = applicationExecutionService.runChallengeAttemptAndSave('Wallet aplicante aqui', challenge.id, 'javascript', jsCode);
